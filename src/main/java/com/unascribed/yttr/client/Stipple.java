...
public class Stipple {
	...
	private static void stipple(long[] arr) {
		if (!RenderBridge.canUseCompatFunctions()) return;
	...
	public static void grey(int amt) {
		stipple(GREYS[Math.floorMod(amt/5, 21)]);
	}
	...
	private static final long[][] GREYS = {GREY_0, GREY_5, GREY_10, GREY_15, GREY_20, GREY_25,
					GREY_30, GREY_35, GREY_40, GREY_45, GREY_50, GREY_55, GREY_60, GREY_65,
					GREY_70, GREY_75, GREY_80, GREY_85, GREY_90, GREY_95, GREY_100};
