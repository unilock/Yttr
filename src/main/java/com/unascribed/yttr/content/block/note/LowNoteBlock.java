...
public class LowNoteBlock extends AltNoteBlock {
	...
	public void buildRemap(Builder<SoundEvent, SoundEvent> builder) {
		builder
			...
			.put(SoundEvents.MUSIC_OVERWORLD_SWAMP, YSounds.LOW_NOTE_BASEDRUM)
			.put(SoundEvents.MUSIC_OVERWORLD_JUNGLE_AND_FOREST, YSounds.LOW_NOTE_BASS)
			.put(SoundEvents.MUSIC_OVERWORLD_OLD_GROWTH_TAIGA, YSounds.LOW_NOTE_BELL)
