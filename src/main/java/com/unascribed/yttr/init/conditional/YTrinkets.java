...
import com.unascribed.yttr.content.item.DiffractorItem;
...
public class YTrinkets {
	...
	private static final DiffractorItem DIFFRACTOR = new DiffractorItem(new Item.Settings().maxCount(1));
	...
	public static void init() {
		...
		YItems.DIFFRACTOR.set(DIFFRACTOR);
